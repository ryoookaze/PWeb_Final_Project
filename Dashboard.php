...
<script src="//code.jquery.com/jquery-1.11.1.min.js"></script>
  ...
  <div class="eight wide column">
    ...
    <div class="col-md-4">
              <div class="thumbnail">
                <img src="imgsource/kolak.jpg" alt="" class="img-responsive" style="height:300px;width:260px">
                <div class="caption">
            ...
            <div class="col-md-4">
              <div class="thumbnail">
                <img src="imgsource/friedrice.jpg" alt="" class="img-responsive" style="height:300px;width:260px">
                <div class="caption">
                  <h4 class="pull-right">$700.99</h4>
                  <h4><a href="#">Mobile Product</a></h4>
                  <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
            ...
            <div class="col-md-4">
              <div class="thumbnail">
                <img src="imgsource/Resep-Bandrek.jpg" alt="" class="img-responsive" style="height:300px;width:260px">
                <div class="caption">
                  <h4 class="pull-right">$700.99</h4>
                  <h4><a href=  "#">Mobile Product</a></h4>
                  <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
